...
class SayThanksWindow(ModalDialog):
    ...
    def _build_ui(self):
        ...
        # Gmail Section
        self.lbl_gmail_hint = ctk.CTkLabel(
            self.main_frame,
            text="",
            justify="center",
            font=(T_FONT_NAME, 14),
        ...
        self.lbl_gmail_hint.grid(row=4, column=0, padx=20, pady=(5, 5))
        ...
        self.img_gmail = ctk.CTkImage(
            light_image=Image.open(resource_path("assets", "gmail-logo.png")),
            size=gmail_size,
        )
        ...
        self.btn_gmail = ctk.CTkButton(
            ...
            height=gmail_size[1],
            corner_radius=0,
            command=lambda: webbrowser.open("https://mail.google.com/mail/?view=cm&fs=1&to=bymykaro@gmail.com"),
        )
        self.btn_gmail.grid(row=5, column=0, padx=20, pady=(0, 15))
    ...
    def rebuild_texts(self):
        ...
        self.lbl_gmail_hint.configure(text=t("thanks.msg_gmail"))
